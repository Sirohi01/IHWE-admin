...
const ConvertedList = () => {
          ...
          <tr key={row._id || i} className={`hover:bg-slate-50 transition-colors ${isSelected ? 'bg-emerald-50/30' : ''}`}>
            ...
            <td className="px-2 py-2">
              <div className="font-bold text-[11px] cursor-pointer hover:text-emerald-600 hover:underline" style={{ color: '#093C5D' }}>
                ...
                } state={{ fromPageLabel: 'Converted Leads' }}>{toTitleCase(row.exhibitorName || row.companyName)}</Link>
              </div>
  ...
  return (
    <BaseLeadPage
      ...
      subtitle="Exhibitors that have successfully registered and confirmed stall bookings"
