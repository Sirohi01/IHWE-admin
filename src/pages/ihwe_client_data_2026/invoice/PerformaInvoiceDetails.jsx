          ...
          <div ref={sameRef} className="performa-print-root max-w-8xl mx-auto bg-white px-6 py-0.5 text-[11px]" style={{ fontFamily: 'Calibri, Arial, sans-serif', fontSize: 11 }}>
            ...
            <div className="invoice-footer-section">
                    ...
                    <td className="ngwpl-bank-details" rowSpan={2} style={{ border: 'none', borderRight: '1px solid #ccc', padding: '2px 8px 2px', verticalAlign: 'top', fontSize: 7, width: '33.33%' }}>
                      <table style={{ borderCollapse: 'collapse', border: 'none', lineHeight: '1.3', width: '100%' }}>
                        <tbody>
                          ...
                          <tr><td style={{ fontWeight: 'bold', whiteSpace: 'nowrap', padding: '1px 4px 1px 0', border: 'none' }}>Account Name</td><td style={{ fontWeight: 'bold', border: 'none', padding: '1px 4px 1px 0' }}>:</td><td style={{ border: 'none', padding: '1px 0', wordBreak: 'break-word' }}>Namo Gange Wellness Pvt. Ltd.</td></tr>
                          <tr><td style={{ fontWeight: 'bold', whiteSpace: 'nowrap', padding: '1px 4px 1px 0', border: 'none' }}>Account No.</td><td style={{ fontWeight: 'bold', border: 'none', padding: '1px 4px 1px 0' }}>:</td><td style={{ border: 'none', padding: '1px 0', wordBreak: 'break-word' }}>6812013962</td></tr>
                          <tr><td style={{ fontWeight: 'bold', whiteSpace: 'nowrap', padding: '1px 4px 1px 0', border: 'none' }}>IFSC Code</td><td style={{ fontWeight: 'bold', border: 'none', padding: '1px 4px 1px 0' }}>:</td><td style={{ border: 'none', padding: '1px 0', fontWeight: 700, color: '#0d1f3c', wordBreak: 'break-word' }}>KKBK0004584</td></tr>
                          <tr><td style={{ fontWeight: 'bold', whiteSpace: 'nowrap', padding: '1px 4px 1px 0', border: 'none' }}>Branch Name</td><td style={{ fontWeight: 'bold', border: 'none', padding: '1px 4px 1px 0' }}>:</td><td style={{ border: 'none', padding: '1px 0', wordBreak: 'break-word' }}>Jagriti Enclave, Anand Vihar, Delhi</td></tr>
                        </tbody>
                      </table>
                    </td>
              ...
              <div className="avoid-break" style={{ position: 'relative', height: 62, overflow: 'hidden', border: '1px solid #ccc', borderTop: 'none' }}>
                ...
                {/* banner text */}
                <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: 34, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: 10, zIndex: 2 }}>
