...
//   // 🧱 Prepare Rows - Filter only "Not Interested" companies
//   const coldClientCompanies = companiesArray.filter(
//     (company) => company.companyStatus === "Not Interested",
//   );

//   const rows = coldClientCompanies.map((c) => ({
//     id: c._id,
//     checkbox: true,
//     company: {
//       name: c.companyName,
