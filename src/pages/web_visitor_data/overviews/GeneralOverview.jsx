...
import {
  fetchGeneralVisitors,
  updateGeneralVisitor,
} from "../../../features/visitor/generalVisitorSlice";
...
const GeneralOverview = () => {
  ...
  }, [dispatch, id, generalVisitors.length]);
  ...
  const handleDelete = async (reviewId) => {
    const result = await Swal.fire({
      ...
      text: "Permanent removal of this review log?",
      icon: "warning",
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      await dispatch(updateGeneralVisitor({ id, data: payload })).unwrap();
    ...
    <div className="bg-white shadow-md mt-6 p-4 md:p-6 min-h-screen font-inter animate-fadeIn">
        ...
        <div className="flex flex-wrap justify-center lg:justify-end gap-2 w-full lg:w-auto">
          {editMode ? (
            ...
            <>
              ...
              <button onClick={() => navigate("/ihweClientData2026/GeneralVisitorsList")} className="flex-1 sm:flex-none px-3 py-1.5 text-[10px] font-bold uppercase bg-[#3598dc] hover:bg-[#286090] text-white transition-colors flex items-center justify-center gap-1.5 rounded-[2px] shadow-sm whitespace-nowrap">
      ...
      <div className="mt-8 space-y-8">
        ...
        <div className="bg-slate-50/50 border border-slate-200 px-4 md:px-6 py-4 rounded-[2px] flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-center md:text-left">
            ...
            <p className="text-[10px] text-slate-400 uppercase tracking-[0.2em] mt-0.5 font-bold">
              General Visitor • International Health & Wellness Expo 2026
            </p>
          </div>
        ...
        <div className="space-y-2">
          ...
          <Section title="Interests & Feedback">
            <div className="p-4 text-[11px] text-slate-500 bg-slate-50 border border-slate-200 rounded-[2px] mx-4 mb-4">
      ...
      <div className="mt-16 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400">
        <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-widest hover:text-[#23471d] transition-colors">
          <ArrowLeft size={14} /> Return to General List
        </button>
        <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-tight">
          <Shield size={14} className="text-green-600" /> Secure Admin Terminal
        </div>
      </div>
