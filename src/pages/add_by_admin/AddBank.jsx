...
const AddBank = () => {
  ...
  const inputCls =
    "w-full px-4 py-2 text-base border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none box-border";
  const thCls =
    "px-5 py-3 text-base font-semibold text-left text-gray-700 border-r border-gray-200";
    ...
    >
      ...
      <div className="w-full bg-white border-b border-gray-200">
        <div className="flex items-center justify-between px-8 py-4">
          <h1 className="text-2xl font-normal" style={{ color: "#666" }}>
            ADD BY ADMIN | ADD BANK
          </h1>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <form
          onSubmit={handleAddOrUpdateBank}
          className="bg-white mb-6 border border-gray-300 rounded-md"
        >
          <div
            className="px-6 py-4 border-b border-gray-300"
            style={{ backgroundColor: "#f9f9f9" }}
          >
            <h2 className="text-xl font-semibold m-0" style={{ color: "#555" }}>
              {editingBank ? "EDIT BANK" : "ADD BANK"}
            </h2>
          </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                />
                {errors.accountno && (
                  <p className="text-red-500 text-sm">{errors.accountno}</p>
                )}
              </div>
            ...
            <div className="mt-8 flex gap-4">
              <button
                type="submit"
                disabled={isLoading}
                className="px-8 py-2 text-base text-white font-semibold cursor-pointer border-none rounded-md"
                style={{
                  backgroundColor: "#337ab7",
                  opacity: isLoading ? 0.6 : 1,
                }}
              ...
              {editingBank && (
                <button
                  type="button"
                  onClick={resetForm}
                  className="px-6 py-2 text-base cursor-pointer border-none rounded-md"
                  style={{
                    backgroundColor: "#e0e0e0",
                    color: "#333",
                  }}
        ...
        <div className="bg-white border border-gray-300 rounded-md">
          {/* Filters */}
          <div
            className="flex items-center justify-between px-6 py-4 border-b border-gray-300 flex-wrap gap-4"
            style={{ backgroundColor: "#f9f9f9" }}
          >
            <div className="flex items-center gap-4">
              <label className="flex items-center gap-2">
                <span className="text-base" style={{ color: "#333" }}>
                  Show
                </span>
                <select
                  value={rowsPerPage}
              ...
              <button className="px-4 py-2 text-base border border-gray-300 bg-gray-50 cursor-pointer rounded-md hover:bg-gray-100">
                Inactive List
              </button>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="px-4 py-2 text-base border border-gray-300 w-56 rounded-md outline-none"
              />
              <button
                onClick={() => {
                  setSearchText("");
                ...
                className="px-4 py-2 text-base border border-gray-300 bg-white cursor-pointer rounded-md hover:bg-gray-50"
              >
                Reset
              </button>
            </div>
          ...
          <div className="overflow-auto max-h-[600px]">
            <table className="w-full border-collapse">
              ...
              >
                <tr className="border-b-2 border-gray-300">
                  <th className={`${thCls} w-16 text-center`}>S.No</th>
                  <th className={thCls}>
                    <div className="flex items-center gap-2">
                      Bank Name
                      <button
                        onClick={() => toggleSort("bankname")}
                        className="bg-transparent border-none cursor-pointer text-sm p-1"
                      >
                        {sortBy.key === "bankname"
                          ? sortBy.dir === "asc"
                            ? "▲"
              ...
              <tbody>
                {isLoading ? (
                  ...
                  <tr>
                    <td
                      colSpan={9}
                      className="py-8 text-center text-red-500 text-base"
                    >
                      Error: {error}
                    </td>
                  </tr>
                  ...
                  currentPageData.map((item, index) => (
                    ...
                    >
                      <td
                        className="px-5 py-4 text-base text-center"
                        style={{ color: "#333" }}
                      >
                        {(currentPage - 1) * rowsPerPage + index + 1}
                      </td>
                      ...
                      <td className="px-5 py-4 text-center">
                        <span
                          className="inline-block px-4 py-1.5 text-sm text-white"
                          style={{
                            backgroundColor:
                              item.status?.toLowerCase() === "active"
                                ? "#337ab7"
                      ...
                      <td className="px-5 py-4 text-center">
                        <div className="flex justify-center gap-3">
                          <button
                            onClick={() => handleEdit(item._id)}
                            className="p-2 bg-white cursor-pointer rounded-md"
                            style={{
                              border: "1px solid #337ab7",
                              color: "#337ab7",
                            }}
          ...
          {/* Footer */}
          <div className="flex items-center justify-between p-4 bg-white flex-wrap gap-4">
