    ...
    return (
        <div className="bg-[#f8fafc] shadow-md px-4 pt-4 pb-1 min-h-[calc(100vh-90px)] font-inter animate-fadeIn">
            ...
            <div className="w-full mt-0 flex flex-col gap-1">
                <section
                    className="hero-background-registration relative overflow-hidden !aspect-auto md:!aspect-[4/1] !h-auto md:!h-auto py-6 md:py-0 rounded-t-xl"
                    style={{
                ...
                <section className="bg-white border border-gray-100 rounded-b-xl shadow-sm px-4 md:px-5 pb-2 md:pb-2 pt-2 md:pt-3 flex flex-col lg:flex-row gap-6 lg:gap-8 -mt-1">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div
                                ...
                                className={`cursor-pointer transition-all duration-300 rounded-xl px-5 pt-2 pb-4 flex flex-col items-center text-center gap-2 border-2 ${buyerType === 'domestic' ? 'bg-[#f0f7e6] border-[#4a8f2f] shadow-lg scale-[1.02]' : 'bg-[#f0f7e6]/50 border-transparent hover:border-[#c8e6a0] hover:bg-[#f0f7e6]'}`}
                            >
                            ...
                            <div
                                ...
                                className={`cursor-pointer transition-all duration-300 rounded-xl px-5 pt-2 pb-4 flex flex-col items-center text-center gap-2 border-2 ${buyerType === 'international' ? 'bg-[#fff7f0] border-[#d26019] shadow-lg scale-[1.02]' : 'bg-[#fff7f0]/50 border-transparent hover:border-[#f5d5b0] hover:bg-[#fff7f0]'}`}
                            >
                                <div className="flex items-center justify-center">
