                            ...
                            {items.map((item) => (
                                <div key={item._id} className="group relative rounded-lg overflow-hidden border border-slate-100 shadow-sm hover:shadow-md transition-all">
                                    ...
                                    <div className="p-3">
                                        ...
                                        <span className={`inline-block mt-2 px-2 py-0.5 rounded-full text-[10px] font-bold ${item.status === 'Active' ? 'bg-green-100 text-green-700' : 'bg-slate-100 text-slate-500'
                                            }`}>
                                            {item.status}
                                        </span>
                                    </div>
