...
import { Trash2, Eye, Edit, Search, Globe, FileText, Download, QrCode, X } from 'lucide-react';
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden flex flex-col">
                        ...
                        <div className="p-6 flex flex-col items-center justify-center bg-white">
                            ...
                            <h4 className="text-lg font-bold text-gray-800 text-center">{selectedQR.brandName || "N/A"}</h4>
                            <p className="text-sm text-gray-500 text-center">{selectedQR.primaryContact?.fullName || "N/A"}</p>
                            <p className="text-xs text-gray-400 text-center mt-1">{selectedQR.primaryContact?.emailId}</p>
                        </div>
