...
const HealthCampOverview = () => {
  ...
  const handlePost = async () => {
    ...
    if (updateHealthCampVisitor.rejected.match(updateResult)) {
      return setPostError(
          ...
          <table className="w-full text-sm border-collapse">
            <tbody>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-3 py-2 text-gray-700 font-medium w-[19%]">
                  {fullName || "N/A"}
                </td>
                <td className="font-medium px-3 py-2 text-gray-500 w-[14%] whitespace-nowrap bg-gray-50">
                  Contact No.
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-3 py-2 text-gray-700 capitalize">
                  {visitor.existingMedicalConditions || "N/A"}
                </td>
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                  Taking Medications
                </td>
                <td className="px-3 py-2 text-gray-700 capitalize">
                  {visitor.isTakingMedications || "N/A"}
                </td>
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                  Medication Names
                </td>
                <td className="px-3 py-2 text-gray-700">
                  {visitor.medicationNames || (
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-3 py-2 text-gray-700 capitalize">
                  {visitor.hasAllergies || "N/A"}
                </td>
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                  Allergy Details
                </td>
                <td className="px-3 py-2 text-gray-700">
                  {visitor.allergyDetails || (
                    <span className="text-gray-400">—</span>
                  )}
                </td>
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                ...
                <td className="px-3 py-2 text-gray-700 capitalize">
                  {visitor.isExperiencingSymptoms || "N/A"}
                </td>
              </tr>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-3 py-2 text-gray-700">
                  {visitor.preferredDate
                    ? formatDate(visitor.preferredDate)
                    : "N/A"}
                </td>
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                  Preferred Time
                ...
                <td className="px-3 py-2 text-gray-700">
                  {visitor.preferredTimeSlot || "N/A"}
                </td>
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                  Consent Medical Data
                </td>
                <td className="px-3 py-2 text-gray-700 capitalize">
                  {visitor.consentMedicalData || "N/A"}
                </td>
              </tr>

              {/* Row 7 — Services (full width) */}
              <tr className="border-b border-gray-200">
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                  Checkup Services
                </td>
              ...
              {/* Row 8 — Concerns (full width) */}
              <tr className="border-b border-gray-200">
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                  Health Concerns
                </td>
                <td colSpan="5" className="px-3 py-2 text-gray-700">
                  {visitor.specificHealthConcerns || "N/A"}
                </td>
              </tr>
