    ...
    return (
        <div className="bg-[#f8fafc] min-h-[calc(100vh-60px)] font-inter pb-10">
            <div className="px-6 py-3 border-b border-slate-200 flex items-center justify-between sticky top-0 bg-white z-50 shadow-sm">
                <div>
                    <h1 className="text-lg font-bold text-slate-800 uppercase tracking-tight">Buyer Registration Config</h1>
                    <p className="text-[9px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-0.5">Manage Dynamic Form Options & Packages</p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={isSaving}
                    ...
                    <div className="space-y-4 animate-fadeIn">
                        <div className="flex justify-between items-center mb-2">
                            <div>
                                ...
                                <p className="text-[10px] text-slate-500">Define the pricing tiers and benefits for buyers</p>
                            </div>
                            <button
                                onClick={addPackage}
