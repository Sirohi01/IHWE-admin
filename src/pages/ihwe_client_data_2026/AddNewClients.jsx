...
const AddNewClients = () => {
  ...
  return (
    ...
    >
      {/* Heading and Navigation Buttons */}
      <div className="w-full h-fit bg-white shadow-md">
        <div className="w-full bg-white flex flex-col sm:flex-row justify-between items-center px-4 py-2">
          ...
          <div className="flex flex-wrap gap-2 cursor-pointer">
            <button
              onClick={handleUploadExhibitor}
              className="px-3 py-2 text-sm font-medium bg-[#3598dc] hover:bg-[#286090] text-white transition-colors"
            >
              Upload Exhibitor
            </button>
            <button
      ...
      {/* Form */}
      <form onSubmit={handleSave} className="max-w-full bg-white shadow-lg m-6">
        <div className="px-6 pb-6 pt-4">
          <h2 className="text-2xl font-normal text-gray-500 mb-2">{heading}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                value={formData.companyName}
                onChange={(e) => handleChange("companyName", e.target.value)}
                className="w-full px-3 py-2 text-sm border border-gray-300 focus:ring-1 focus:ring-blue-500 focus:border-transparent focus:outline-none"
                placeholder="Enter company name"
                required
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-4">
            <div>
              ...
              <select
                ...
                disabled={!formData.country}
                className="w-full px-3 py-2 text-sm border border-gray-300 disabled:bg-gray-100 focus:ring-1 focus:ring-blue-500 focus:border-transparent focus:outline-none"
                required
              >
                <option value="">Select State Here</option>
                {formData.country &&
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => handleChange("forwardTo", e.target.value)}
                disabled={!!id}
                className="w-full px-3 py-2 text-sm border border-gray-300 disabled:bg-gray-200 focus:ring-1 focus:ring-blue-500 focus:border-transparent focus:outline-none"
                required
              >
                <option value="">Select Here</option>
                {users?.map((user, i) => (
          ...
          {formData.contacts.map((contact, index) => (
            <div key={index} className="pb-4 pt-2 bg-gray-50 mb-2">
                  ...
                  <div className="flex justify-between items-center mb-1">
                    ...
                    {index === 0 ? (
                      <button
                        type="button"
                        onClick={addContact}
                        className="bg-green-500 hover:bg-green-600 text-white px-3 py-1 flex items-center justify-center text-base font-bold"
                      >
                        +
                      </button>
                    ) : (
                      <button
                        type="button"
                        onClick={() => removeContact(index)}
                        className="bg-red-500 hover:bg-red-600 text-white px-3 py-1 flex items-center justify-center text-base font-bold"
                      >
                        -
                      </button>
                    )}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pt-4">
            <p className="text-sm text-gray-600 mb-3 sm:mb-0">
              <span className="text-red-500 text-base">*</span> Required Fields
            </p>
            <div className="flex gap-2">
              <button
                type="submit"
                className="px-5 py-2 text-sm bg-[#337ab7] hover:bg-[#286090] text-white flex items-center gap-2"
              >
                {buttonName} <IoIosArrowDroprightCircle />
              </button>
              <button
                type="button"
                onClick={handleReset}
                className="px-5 py-2 text-sm bg-red-600 hover:bg-red-700 text-white"
              >
                Reset
              </button>
            </div>
