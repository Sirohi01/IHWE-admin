...
const FORM_TYPES = [
    ...
    { id: 'exhibitor-registration', label: 'Exh: Reg. Received', icon: Briefcase, color: 'text-purple-600', bg: 'bg-purple-50' },
    { id: 'exhibitor-registration-approved', label: 'Exh: Reg. Approved', icon: CheckCircle, color: 'text-emerald-700', bg: 'bg-emerald-50' },
    { id: 'exhibitor-payment-receipt', label: 'Exh: Payment Receipt', icon: Ticket, color: 'text-emerald-600', bg: 'bg-emerald-50' },
    { id: 'exhibitor-booking-confirmed', label: 'Exh: Booking Confirmed', icon: CheckCircle, color: 'text-blue-600', bg: 'bg-blue-50' },
    { id: 'exhibitor-registration-rejection', label: 'Exh: Reg. Rejected', icon: Trash2, color: 'text-red-600', bg: 'bg-red-50' },
    { id: 'exhibitor-payment-failed', label: 'Exh: Payment Failed', icon: X, color: 'text-red-700', bg: 'bg-red-50' },
    { id: 'exhibitor-accessory-order', label: 'Exh: Accessory Order', icon: List, color: 'text-amber-600', bg: 'bg-amber-50' },
...
const PLACEHOLDERS = {
    ...
    'exhibitor-registration': ['[[EXHIBITOR_NAME]]', '[[CONTACT_PERSON]]', '[[DESIGNATION]]', '[[STALL_NO]]', '[[STALL_TYPE]]', '[[STALL_SCHEME]]', '[[STALL_DIMENSION]]', '[[STALL_SIZE]]', '[[EVENT_NAME]]', '[[REGISTRATION_ID]]', '[[LOGIN_URL]]', '[[PASSWORD]]'],
    'exhibitor-registration-approved': ['[[EXHIBITOR_NAME]]', '[[CONTACT_PERSON]]', '[[STALL_NO]]', '[[STALL_TYPE]]', '[[EVENT_NAME]]', '[[REGISTRATION_ID]]', '[[LOGIN_URL]]', '[[USERNAME]]', '[[PASSWORD]]'],
    'exhibitor-payment-receipt': ['[[EXHIBITOR_NAME]]', '[[CONTACT_PERSON]]', '[[REGISTRATION_ID]]', '[[STALL_NO]]', '[[STALL_TYPE]]', '[[STALL_SCHEME]]', '[[STALL_DIMENSION]]', '[[STALL_SIZE]]', '[[TOTAL_AMOUNT]]', '[[AMOUNT_PAID]]', '[[BALANCE_DUE]]', '[[PAYMENT_MODE]]', '[[PAYMENT_METHOD]]', '[[TRANSACTION_ID]]'],
    'exhibitor-booking-confirmed': ['[[EXHIBITOR_NAME]]', '[[CONTACT_PERSON]]', '[[REGISTRATION_ID]]', '[[STALL_NO]]', '[[STALL_TYPE]]', '[[STALL_SCHEME]]', '[[STALL_DIMENSION]]', '[[STALL_SIZE]]', '[[EVENT_NAME]]', '[[LOGIN_URL]]'],
    'exhibitor-registration-rejection': ['[[EXHIBITOR_NAME]]', '[[CONTACT_PERSON]]', '[[REGISTRATION_ID]]', '[[EVENT_NAME]]'],
    'exhibitor-payment-failed': ['[[EXHIBITOR_NAME]]', '[[CONTACT_PERSON]]', '[[STALL_NO]]', '[[REGISTRATION_ID]]', '[[LOGIN_URL]]'],
    'exhibitor-accessory-order': ['[[EXHIBITOR_NAME]]', '[[CONTACT_PERSON]]', '[[ORDER_NO]]', '[[STALL_NO]]', '[[GRAND_TOTAL]]', '[[ITEM_TABLE]]'],
