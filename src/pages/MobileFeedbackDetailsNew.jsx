...
const SectionCard = ({ title, icon: Icon, headerBg, headerText, bodyBg = "bg-white", children }) => (
...
const BasicDetailRow = ({ icon: Icon, label, value }) => (
    ...
    <div className="p-2 bg-[#F8FAFC] min-h-screen font-inter print:bg-white print:p-0 print:min-h-0">
      ...
      <div className="print:hidden w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
            ...
            <SectionCard title="DECLARATION & MEDIA" icon={Shield} headerBg="bg-[#FEF2F2]" headerText="text-rose-600">
              <div className="space-y-2">
                ...
                <div className="space-y-1.5 pt-2 border-t border-slate-100">
                  <a href={responses?.testimonialFile ? (SERVER_URL + responses.testimonialFile) : "#"} target="_blank" rel="noreferrer" className="w-full flex items-center justify-center gap-1 py-1.5 text-purple-600 bg-white border border-purple-200 hover:bg-purple-50 rounded-md text-[9px] font-bold transition-colors">
                    <Download size={10} /> Download Testimonial
                  </a>
                  <a href={responses?.videoFeedbackFile ? (SERVER_URL + responses.videoFeedbackFile) : "#"} target="_blank" rel="noreferrer" className="w-full flex items-center justify-center gap-1 py-1.5 text-pink-600 bg-white border border-pink-200 hover:bg-pink-50 rounded-md text-[9px] font-bold transition-colors">
          ...
          <div className="lg:col-span-2 space-y-2">
             <SectionCard title="Buisness Outcome" icon={MessageSquare} headerBg="bg-[#334155]" headerText="text-white">
