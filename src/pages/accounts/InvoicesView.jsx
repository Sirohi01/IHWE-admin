                ...
                <>
                    ...
                    <div className="flex flex-col lg:flex-row gap-2">
                        ...
                        <div className="w-full lg:w-[20%] flex flex-col gap-2">
                            ...
                            {/* Top Overdue */}
                            <div className="bg-white rounded-xl border border-slate-200 p-3 shadow-sm">
                                <h2 className="text-sm font-semibold text-slate-800 mb-3 tracking-wide flex items-center justify-between">
                                    <span>Top Overdue</span>
                                    <span className="text-[9px] text-rose-500 font-bold bg-rose-50 px-1.5 py-0.5 rounded uppercase tracking-wider">Action Req</span>
                                </h2>
                                <div className="space-y-3">
                                    {rows
                                        ...
                                        .slice(0, 4)
                                        .map((r, i) => (
                                            <div key={i} className="flex items-center justify-between group cursor-pointer hover:bg-slate-50 p-1.5 -mx-1.5 rounded-lg transition-colors" onClick={() => navigate(`/payments/invoiceDetails/${r.id}`)}>
                                                <div>
                                                    <div className="text-[11px] font-bold text-slate-800 line-clamp-1 group-hover:text-blue-600 transition-colors">{r.client}</div>
                                                    <div className="text-[9px] text-slate-500 font-medium mt-0.5">{r.invNo} • Due {formatDate(r.dueDate)}</div>
                                                </div>
                                                <div className="text-[11px] font-black text-rose-600 shrink-0">
                                    ...
                                    {rows.filter(r => r.status === 'Overdue').length === 0 && (
                                        <div className="text-[11px] font-medium text-emerald-600 bg-emerald-50 rounded-lg p-2 text-center flex flex-col items-center gap-1">
