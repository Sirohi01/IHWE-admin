...
//                 } else {
//                     setFormData(prev => ({ ...prev, mobileOtpSent: true }));
...
//         const identifier = type === 'email' ? formData.emailAddress : formData.mobileNumber;
//         const otp = type === 'email' ? formData.emailOtpValue : formData.mobileOtpValue;
//         if (!otp) {
...
//                 } else {
//                     setFormData(prev => ({ ...prev, mobileOtpVerified: true }));
//                 }
//             } else {
...
//         // OTP validation
//         if (!formData.emailOtpVerified) nextErrors.emailAddress = "Please verify your email via OTP";
//         if (!formData.mobileOtpVerified) nextErrors.mobileNumber = "Please verify your mobile via OTP";
...
//     const handlePackageSelect = (pkg) => {
//         if (!canSelectPackage) {
//             toast.error("Please complete all required fields and verify OTP before selecting a package.");
//             return;
//         }
//         setSelectedPackage(pkg);
//         setFormData((prev) => ({ ...prev, registrationCategory: pkg.name, registrationFee: formatCurrency(pkg.price) }));
...
//             return;
//         }
//         if (!formData.emailOtpVerified || !formData.mobileOtpVerified) {
...
//                     {/* Contact Information with OTP */}
//                     <section>
//                         <SectionTitle icon={Phone} title="Contact Information" />
//                         <div className="grid gap-x-4 gap-y-3 md:grid-cols-2 xl:grid-cols-4">
//                             <Field label="Mobile Number (10 digits) *" name="mobileNumber" required error={errors.mobileNumber}>
//                                 <div className="flex gap-2">
//                                     <input id="mobileNumber" name="mobileNumber" value={formData.mobileNumber} onChange={handleInputChange} placeholder="10-digit mobile number" className={inputClass} maxLength={10} disabled={formData.mobileOtpVerified || formData.mobileOtpSent} />
//                                     {!formData.mobileOtpVerified && !formData.mobileOtpSent && (
//                                         <button type="button" onClick={() => requestOtp('mobile')} disabled={isVerifying.mobile || formData.mobileNumber.length !== 10} className="bg-[#23471d] text-[10px] h-8 px-3 whitespace-nowrap rounded-[2px] font-bold uppercase tracking-wider text-white">
//                                             {isVerifying.mobile ? <Loader2 className="animate-spin h-3 w-3" /> : 'Send OTP'}
//                                         </button>
//                                     )}
//                                     {formData.mobileOtpSent && !formData.mobileOtpVerified && (
//                                         <button type="button" onClick={() => verifyOtp('mobile')} disabled={isVerifying.mobile || !formData.mobileOtpValue} className="bg-[#23471d] text-[10px] h-8 px-3 whitespace-nowrap rounded-[2px] font-bold uppercase tracking-wider text-white">
//                                             {isVerifying.mobile ? <Loader2 className="animate-spin h-3 w-3" /> : 'Verify'}
//                                         </button>
//                                     )}
//                                     {formData.mobileOtpVerified && <CheckCircle2 className="h-5 w-5 text-emerald-500 self-center shrink-0" />}
//                                 </div>
//                             </Field>
//                             <Field label="Alternate Number (10 digits) *" name="alternateNumber" required error={errors.alternateNumber}>
//                                 <input id="alternateNumber" name="alternateNumber" value={formData.alternateNumber} onChange={handleInputChange} placeholder="10-digit alternate number" className={inputClass} maxLength={10} />
//                             </Field>
//                             <Field label="Email Address (OTP) *" name="emailAddress" required error={errors.emailAddress}>
//                                 <div className="flex gap-2">
//                                     <input id="emailAddress" name="emailAddress" type="email" value={formData.emailAddress} onChange={handleInputChange} placeholder="Work Email" className={inputClass} disabled={formData.emailOtpVerified || formData.emailOtpSent} />
//                                     {!formData.emailOtpVerified && !formData.emailOtpSent && (
//                                         <button type="button" onClick={() => requestOtp('email')} disabled={isVerifying.email || !formData.emailAddress} className="bg-[#23471d] text-[10px] h-8 px-3 whitespace-nowrap rounded-[2px] font-bold uppercase tracking-wider text-white">
//                                             {isVerifying.email ? <Loader2 className="animate-spin h-3 w-3" /> : 'Send OTP'}
//                                         </button>
//                                     )}
//                                     {formData.emailOtpSent && !formData.emailOtpVerified && (
//                                         <button type="button" onClick={() => verifyOtp('email')} disabled={isVerifying.email || !formData.emailOtpValue} className="bg-[#23471d] text-[10px] h-8 px-3 whitespace-nowrap rounded-[2px] font-bold uppercase tracking-wider text-white">
//                                             {isVerifying.email ? <Loader2 className="animate-spin h-3 w-3" /> : 'Verify'}
//                                         </button>
//                                     )}
//                                     {formData.emailOtpVerified && <CheckCircle2 className="h-5 w-5 text-emerald-500 self-center shrink-0" />}
//                                 </div>
//                             </Field>
...
//                                     <input placeholder="Enter 6-digit OTP" value={formData.mobileOtpValue} onChange={(e) => setFormData(prev => ({ ...prev, mobileOtpValue: e.target.value }))} className={`${inputClass} tracking-[0.3em] text-center font-bold`} maxLength={6} />
//                                     {mobileResendTimer > 0 ? (
//                                         <span className="text-[10px] font-bold text-slate-400">Resend in {mobileResendTimer}s</span>
//                                     ) : (
//                                         <button type="button" onClick={() => requestOtp('mobile')} disabled={isVerifying.mobile} className="text-[10px] font-bold text-[#23471d] hover:underline">Resend OTP</button>
//                                     )}
//                                 </div>
//                             </div>
//                         )}
...
//                             <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-2">
//                                 <div className="flex gap-2 items-center">
//                                     <input placeholder="Enter 6-digit OTP" value={formData.emailOtpValue} onChange={(e) => setFormData(prev => ({ ...prev, emailOtpValue: e.target.value }))} className={`${inputClass} tracking-[0.3em] text-center font-bold`} maxLength={6} />
//                                     {emailResendTimer > 0 ? (
//                                         <span className="text-[10px] font-bold text-slate-400">Resend in {emailResendTimer}s</span>
//                                     ) : (
//                                         <button type="button" onClick={() => requestOtp('email')} disabled={isVerifying.email} className="text-[10px] font-bold text-[#23471d] hover:underline">Resend OTP</button>
//                                     )}
//                                 </div>
//                             </div>
//                         )}
...
//                             <Field label="Country" name="country" required error={errors.country} className="xl:col-span-1">
//                                 <select id="country" name="country" value={formData.country} onChange={(e) => handleSelectChange("country", e.target.value)} className={inputClass}>
//                                     <option value="">Select country</option>
//                                     {countries.map((item) => (<option key={item._id || item.name} value={item.name}>{item.name}</option>))}
//                                 </select>
//                             </Field>
//                             <Field label="State/Province *" name="stateProvince" required error={errors.stateProvince} className="xl:col-span-2">
//                                 <select id="stateProvince" name="stateProvince" value={formData.stateProvince} onChange={(e) => handleSelectChange("stateProvince", e.target.value)} className={inputClass} disabled={loadingLocations.states}>
...
//                                 </select>
//                             </Field>
//                             <Field label="City *" name="city" required error={errors.city} className="xl:col-span-2">
//                                 <select id="city" name="city" value={formData.city} onChange={(e) => handleSelectChange("city", e.target.value)} className={inputClass} disabled={!formData.stateProvince || loadingLocations.cities}>
...
//                                 </select>
//                             </Field>
//                             <Field label="Pin Code (6 digits) *" name="pinCode" required error={errors.pinCode} className="xl:col-span-1">
...
//                             </Field>
//                             <Field label="Registered Address *" name="registeredAddress" required error={errors.registeredAddress} className="xl:col-span-6">
//                                 <textarea id="registeredAddress" name="registeredAddress" value={formData.registeredAddress} onChange={handleInputChange} placeholder="Full Corporate Address" className={`${inputClass} min-h-[60px] resize-y`} />
//                             </Field>
//                         </div>
//                     </section>
...
//                         <SectionTitle icon={Building2} title="1. Company Business Profile" />
//                         <div className="grid gap-x-4 gap-y-3 md:grid-cols-2 xl:grid-cols-5">
//                             <Field label="Company / Firm Name *" name="companyFirmName" required error={errors.companyFirmName} className="">
//                                 <input id="companyFirmName" name="companyFirmName" value={formData.companyFirmName} onChange={handleInputChange} placeholder="Company / Firm Name" className={inputClass} />
//                             </Field>
//                             <Field label="Brand Name" name="brandName">
//                                 <input id="brandName" name="brandName" value={formData.brandName} onChange={handleInputChange} placeholder="Brand Name" className={inputClass} />
...
//                                 <input id="gstNumber" name="gstNumber" value={formData.gstNumber} onChange={handleInputChange} placeholder="GST Number" className={inputClass} />
//                             </Field>
//                             <Field label="PAN Number (Optional)" name="panNumber">
//                                 <input id="panNumber" name="panNumber" value={formData.panNumber} onChange={handleInputChange} placeholder="PAN Number" className={inputClass} />
//                             </Field>
//                             <Field label="Buyer Industry *" name="buyerIndustry" required error={errors.buyerIndustry}>
//                                 <select id="buyerIndustry" name="buyerIndustry" value={formData.buyerIndustry} onChange={(e) => handleSelectChange("buyerIndustry", e.target.value)} className={inputClass}>
...
//                         <SectionTitle icon={FileText} title="2. Business Profile Details" />
//                         <div className="grid gap-x-4 gap-y-3 md:grid-cols-2 xl:grid-cols-5">
//                             <Field label="Nature of Business *" name="natureOfBusiness" required error={errors.natureOfBusiness} className="">
//                                 <input id="natureOfBusiness" name="natureOfBusiness" value={formData.natureOfBusiness} onChange={handleInputChange} placeholder="Short description" className={inputClass} />
//                             </Field>
//                             <Field label="Years in Business *" name="yearsInBusiness" required error={errors.yearsInBusiness}>
//                                 <input id="yearsInBusiness" name="yearsInBusiness" type="number" min="0" value={formData.yearsInBusiness} onChange={handleInputChange} placeholder="e.g. 10" className={inputClass} />
...
//                                     <select id="primaryProductInterest" name="primaryProductInterest" value={formData.primaryProductInterest} onChange={(e) => handleSelectChange("primaryProductInterest", e.target.value)} className={inputClass}>
...
//                                     <label className={labelClass}>Secondary Product Categories</label>
//                                     <MultiSelectDropdown
//                                         options={normalizedConfig.secondaryProductCategories}
//                                         selected={formData.secondaryProductCategories}
//                                         onChange={(val) => setFormData(prev => ({ ...prev, secondaryProductCategories: val }))}
...
//                             </div>
//                             <div className="grid gap-x-4 gap-y-3 md:grid-cols-2 xl:grid-cols-5">
//                                 <Field label="Interested in Importing Products?" name="interestedInImporting">
//                                     <select id="interestedInImporting" name="interestedInImporting" value={formData.interestedInImporting} onChange={(e) => handleSelectChange("interestedInImporting", e.target.value)} className={inputClass}>
//                                         {['Yes', 'No'].map(o => <option key={o} value={o}>{o}</option>)}
//                                     </select>
//                                 </Field>
//                                 <Field label="Interested in Export Partnerships?" name="interestedInExporting">
//                                     <select id="interestedInExporting" name="interestedInExporting" value={formData.interestedInExporting} onChange={(e) => handleSelectChange("interestedInExporting", e.target.value)} className={inputClass}>
//                                         {['Yes', 'No'].map(o => <option key={o} value={o}>{o}</option>)}
//                                     </select>
//                                 </Field>
//                                 <Field label="Business Model Preference" name="businessModelPreference">
//                                     <select id="businessModelPreference" name="businessModelPreference" value={formData.businessModelPreference} onChange={(e) => handleSelectChange("businessModelPreference", e.target.value)} className={inputClass}>
//                                         <option value="">Select Model</option>
//                                         {normalizedConfig.businessModelOptions.map((m) => (<option key={m} value={m}>{m}</option>))}
//                                     </select>
//                                 </Field>
//                                 <Field label="Estimated Monthly Purchase" name="estimatedPurchaseVolume">
...
//                                     <select id="budgetRange" name="budgetRange" value={formData.budgetRange} onChange={(e) => handleSelectChange("budgetRange", e.target.value)} className={inputClass}>
//                                         <option value="">Choose Budget</option>
//                                         {normalizedConfig.budgetRanges.map((item) => (<option key={item} value={item}>{item}</option>))}
//                                     </select>
//                                 </Field>
//                                 <Field label="Buying Frequency" name="buyingFrequency">
//                                     <select id="buyingFrequency" name="buyingFrequency" value={formData.buyingFrequency} onChange={(e) => handleSelectChange("buyingFrequency", e.target.value)} className={inputClass}>
//                                         <option value="">Select</option>
//                                         {(normalizedConfig.buyingFrequencies || ['One-time', 'Monthly', 'Quarterly', 'Long-term']).map(f => <option key={f} value={f}>{f}</option>)}
//                                     </select>
//                                 </Field>
//                                 <Field label="Est. Annual Purchase Value *" name="estimatedAnnualPurchaseValue" required error={errors.estimatedAnnualPurchaseValue}>
//                                     <select id="estimatedAnnualPurchaseValue" name="estimatedAnnualPurchaseValue" value={formData.estimatedAnnualPurchaseValue} onChange={(e) => handleSelectChange("estimatedAnnualPurchaseValue", e.target.value)} className={inputClass}>
//                                         <option value="">Select</option>
...
//                                     <select id="purchaseTimeline" name="purchaseTimeline" value={formData.purchaseTimeline} onChange={(e) => handleSelectChange("purchaseTimeline", e.target.value)} className={inputClass}>
//                                         <option value="">Select</option>
...
//                                     <select id="matchmakingInterest" name="matchmakingInterest" value={formData.matchmakingInterest} onChange={(e) => handleSelectChange("matchmakingInterest", e.target.value)} className={inputClass}>
//                                         <option value="Yes">Yes</option>
//                                         <option value="No">No</option>
//                                     </select>
//                                 </Field>
//                                 <Field label="Role in Purchase Decision *" name="roleInPurchaseDecision" required error={errors.roleInPurchaseDecision}>
//                                     <select id="roleInPurchaseDecision" name="roleInPurchaseDecision" value={formData.roleInPurchaseDecision} onChange={(e) => handleSelectChange("roleInPurchaseDecision", e.target.value)} className={inputClass}>
...
//                             </div>
//                             <Field label="Specific Product Requirements" name="specificProductRequirements">
//                                 <textarea id="specificProductRequirements" name="specificProductRequirements" value={formData.specificProductRequirements} onChange={handleInputChange} placeholder="Any custom needs..." className={`${inputClass} min-h-[60px] resize-y`} />
//                             </Field>
//                         </div>
//                     </section>
...
//                                 <div>
//                                     <label className={labelClass}>Preferred Supplier Region *</label>
//                                     <MultiSelectDropdown
//                                         options={normalizedConfig.regions || ['North India', 'South India', 'East India', 'West India', 'Pan India', 'Global']}
//                                         selected={formData.preferredSupplierRegion}
//                                         onChange={(val) => { setFormData(prev => ({ ...prev, preferredSupplierRegion: val })); setErrors(prev => ({ ...prev, preferredSupplierRegion: '' })); }}
...
//                                     <MultiSelectDropdown
//                                         options={normalizedConfig.supplierTypes || ['Manufacturer', 'Exporter', 'MSME', 'Startup', 'Wholesaler']}
//                                         selected={formData.preferredSupplierType}
//                                         onChange={(val) => { setFormData(prev => ({ ...prev, preferredSupplierType: val })); setErrors(prev => ({ ...prev, preferredSupplierType: '' })); }}
...
//                                         onChange={(val) => setFormData(prev => ({ ...prev, preferredState: val }))}
...
//                                     <select id="preferredCompanySize" name="preferredCompanySize" value={formData.preferredCompanySize} onChange={(e) => handleSelectChange("preferredCompanySize", e.target.value)} className={inputClass}>
...
//                         <SectionTitle icon={ShieldCheck} title="Certification & Compliance" />
//                         <div className="space-y-6">
//                             {/* Single Row with 5 Columns - All Same Size */}
//                             <div className="grid gap-5 md:grid-cols-5">

//                                 {/* Column 1: Required Certifications */}
//                                 <div className="flex flex-col">
//                                     <label className={labelClass}>Required Certifications</label>
//                                     <div className="h-9"> {/* Fixed height wrapper */}
//                                         <MultiSelectDropdown
//                                             options={normalizedConfig.certificationOptions || ['ISO', 'GMP', 'FDA', 'AYUSH', 'Organic', 'Halal', 'Kosher', 'Others']}
//                                             selected={formData.requiredCertifications}
//                                             onChange={(val) => setFormData(prev => ({ ...prev, requiredCertifications: val }))}
...
//                                         onChange={(e) => handleSelectChange("pricingPreference", e.target.value)}
//                                         className="h-11 w-full rounded-md border border-slate-300 bg-white px-3 text-sm focus:border-[#23471d] focus:outline-none focus:ring-1 focus:ring-[#23471d]"
//                                     >
...
//                                 {/* Column 3: Preferred Payment Methods */}
//                                 <div className="flex flex-col">
//                                     <label className={labelClass}>Preferred Payment Methods</label>
//                                     <div className="h-9"> {/* Fixed height wrapper */}
//                                         <MultiSelectDropdown
//                                             options={['Letter of Credit (LC)', 'Cash Against Documents (CAD)', 'Bank Transfer (T/T)', 'Open Account', 'Advance Payment']}
//                                             selected={formData.preferredPaymentMethods}
//                                             onChange={(val) => setFormData(prev => ({ ...prev, preferredPaymentMethods: val }))}
...
//                                 {/* Column 4: Company Profile */}
//                                 <div className="flex flex-col">
//                                     <label className={labelClass}>Company Profile</label>
//                                     <div className="relative h-9"> {/* Fixed height container */}
//                                         <input
//                                             type="file"
//                                             id="companyProfile"
//                                             name="companyProfile"
...
//                                             className="absolute inset-0 z-10 h-full w-full cursor-pointer opacity-0"
//                                         />
//                                         <div className="flex h-11 w-full items-center justify-between rounded-md border border-slate-300 bg-white px-3 text-sm text-slate-500">
...
//                                 {/* Column 5: Logistics Requirements */}
//                                 <div className="flex flex-col">
//                                     <label className={labelClass}>Logistics Requirements</label>
//                                     <textarea
//                                         id="logisticsRequirements"
//                                         name="logisticsRequirements"
//                                         value={formData.logisticsRequirements}
//                                         onChange={handleInputChange}
//                                         placeholder="e.g. Sea freight, Door-to-door..."
//                                         rows={1}
//                                         className="h-11 w-full resize-none rounded-md border border-slate-300 bg-white px-3 py-1.5 text-sm focus:border-[#23471d] focus:outline-none focus:ring-1 focus:ring-[#23471d]"
//                                     />
//                                 </div>
//                             </div>
//                         </div>
...
//                             <div className="grid gap-5 md:grid-cols-5">
//                                 {/* Column 1 */}
//                                 <Field label=" Pre-scheduled B2B Meetings? *" name="requirePreScheduledB2B">
//                                     <select
//                                         id="requirePreScheduledB2B"
//                                         name="requirePreScheduledB2B"
//                                         value={formData.requirePreScheduledB2B}
//                                         onChange={(e) => handleSelectChange("requirePreScheduledB2B", e.target.value)}
...
//                                         onChange={(e) => handleSelectChange("meetingPriorityLevel", e.target.value)}
//                                         className={`${inputClass} h-9`}
//                                     >
...
//                                             onChange={(val) => {
//                                                 setFormData(prev => ({ ...prev, preferredMeetingCategories: val }));
//                                                 setErrors(prev => ({ ...prev, preferredMeetingCategories: '' }));
//                                             }}
//                                             placeholder="Select categories..."
...
//                                 {/* Column 4 */}
//                                 <div>
//                                     <label className={labelClass}>Exhibitor Types to Meet</label>
//                                     <div className="h-9">
//                                         <MultiSelectDropdown
//                                             options={normalizedConfig.exhibitorTypeOptions}
//                                             selected={formData.preferredExhibitorTypes}
//                                             onChange={(val) => setFormData(prev => ({ ...prev, preferredExhibitorTypes: val }))}
...
//                                             onChange={(val) => {
//                                                 setFormData(prev => ({ ...prev, meetingObjectives: val }));
//                                                 setErrors(prev => ({ ...prev, meetingObjectives: '' }));
//                                             }}
...
//                                 {/* Column 1 */}
//                                 <div>
//                                     <label className={labelClass}>🏷 Preferred Business Type *</label>
//                                     <div className="h-9">
//                                         <MultiSelectDropdown
//                                             options={normalizedConfig.preferredBusinessTypeOptions}
//                                             selected={formData.preferredBusinessTypes}
//                                             onChange={(val) => {
//                                                 setFormData(prev => ({ ...prev, preferredBusinessTypes: val }));
//                                                 setErrors(prev => ({ ...prev, preferredBusinessTypes: '' }));
//                                             }}
...
//                                 <Field label="Preferred Day *" name="preferredMeetingDay" required error={errors.preferredMeetingDay}>
//                                     <select
//                                         id="preferredMeetingDay"
//                                         name="preferredMeetingDay"
//                                         value={formData.preferredMeetingDay}
//                                         onChange={(e) => handleSelectChange("preferredMeetingDay", e.target.value)}
//                                         className={`${inputClass} h-9`}
//                                     >
//                                         <option value="">Select Day</option>
//                                         {normalizedConfig.meetingDayOptions.map(day => (
...
//                                     >
//                                         <option value="">Select Slot</option>
//                                         {['Morning (10AM - 1PM)', 'Afternoon (2PM - 4PM)', 'Evening (4PM - 6PM)'].map(slot => (
...
//                                 <Field label="Number of Meetings" name="numberOfMeetingsInterested">
//                                     <select
//                                         id="numberOfMeetingsInterested"
//                                         name="numberOfMeetingsInterested"
//                                         value={formData.numberOfMeetingsInterested}
//                                         onChange={(e) => handleSelectChange("numberOfMeetingsInterested", e.target.value)}
//                                         className={`${inputClass} h-9`}
//                                     >
//                                         <option value="">Select Count</option>
...
//                                 {/* Column 5 - Empty or Placeholder if needed */}
//                                 <div>
//                                     {/* You can add Remarks field here if needed */}
//                                 </div>
//                             </div>

//                             {/* Row 3 - Full Width Textarea (if needed) */}
//                             {formData.requirePreScheduledB2B === 'Yes' && (
//                                 <div className="grid gap-5 md:grid-cols-1">
//                                     <Field label="📝 Specific Meeting Requirements" name="meetingRequirements">
//                                         <textarea
//                                             id="meetingRequirements"
...
//                                             className={`${inputClass} h-9 resize-none`}
//                                         />
//                                     </Field>
//                                 </div>
//                             )}
...
//                             <textarea id="remarks" name="remarks" value={formData.remarks} onChange={handleInputChange} placeholder="Any internal or buyer-side notes for the registration." className={`${inputClass} min-h-[90px] resize-y`} />
//                         </Field>
//                     </section>
...
//                                         {canSelectPackage ?
//                                             "✅ All required fields completed! You can now select a package below." :
//                                             "⚠️ Please complete all required fields above and verify OTP to unlock package selection."}
//                                     </p>
//                                 </div>
...
//                         <div className="flex flex-wrap gap-3">
//                             <button type="button" onClick={() => handleReset(true)} className="rounded-[2px] border border-red-200 bg-red-50 px-5 py-3 text-sm font-bold uppercase tracking-[0.16em] text-red-700 transition hover:bg-red-100">Reset Form</button>
//                             <button type="submit" disabled={isSubmitting || normalizedPackages.length === 0 || !selectedPackage || selectedPaymentMethods.length === 0 || !formData.emailOtpVerified || !formData.mobileOtpVerified} className="inline-flex items-center gap-2 rounded-[2px] bg-[#23471d] px-6 py-3 text-sm font-black uppercase tracking-[0.16em] text-white transition hover:bg-[#1a3516] disabled:cursor-not-allowed disabled:opacity-60">
//                                 {isSubmitting ? (<><Loader2 className="h-4 w-4 animate-spin" /> Submitting...</>) : (<><CheckCircle2 className="h-4 w-4" /> Submit Registration</>)}
//                             </button>
//                         </div>
//                     </div>
