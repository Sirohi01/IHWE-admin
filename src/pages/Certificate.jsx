    ...
    <div className="flex flex-col items-center p-2 sm:p-6 bg-[#e5e7eb] min-h-[calc(100vh-60px)] font-serif">
      ...
      <div
        ...
        style={{
          width: '100%',
          maxWidth: '850px',
          aspectRatio: '297 / 420', // EXACT A3 Ratio
      ...
      >
        <div className="absolute inset-0 px-[10%] pt-[8%] pb-[4%] flex flex-col items-center z-10">

          {/* Header Row */}
          <div className="w-full flex justify-between items-start">
            {/* Left: Govt Logo */}
            <div className="w-[18%] flex flex-col items-center">
              <span className="text-[#7a5725] font-bold mb-[2%] underline underline-offset-[3px]" style={{ fontFamily: '"Aladin", cursive' }}>SUPPORTED BY:</span>
            ...
            <div className="w-[30%] flex flex-col items-center mt-[1%]">
              ...
              <p className="mt-[3%] text-3xl font-bold text-[#1f385c]" style={{ fontFamily: '"Aladin", cursive' }}>Presents</p>
            </div>
          ...
          <div className="text-center font-bold text-[#000]" style={{ fontFamily: '"Aladin", cursive' }}>
            {certData?.certi_description ? (
              <div
                dangerouslySetInnerHTML={{ __html: certData.certi_description }}
                className="leading-[1.2] mb-[3%]"
                style={{ fontSize: '1.9cqi' }}
              />
            ) : (
              <>
                <p className="whitespace-nowrap leading-[1.2] mb-[3%]" style={{ fontSize: '1.9cqi' }}>
                ...
                <p className="whitespace-nowrap leading-[1.3] mb-[3%]" style={{ fontSize: '1.9cqi' }}>
          ...
          {/* Signatures */}
          <div className="w-[60%] mt-[5%] pt-[2%] border-t-[1.5px] border-[#c5a977] flex justify-between">
          ...
          <div className="w-[95%] flex flex-col items-center mt-[2%] pb-[2%]">
            ...
            <div className="text-center mb-[0.5%]">
              <span className="text-[#83654D] font-bold text-xl" style={{ fontFamily: '"Aladin", cursive' }}>Namo Gange Trust Initiatives</span>
            </div>
            ...
            <div className="w-[95%] flex flex-col mb-[3%] mt-[1%]">
              {/* Headings Row */}
              <div className="flex w-full mb-[0.5%] justify-center">
                <img src={concurrentEvents} alt="Concurrent Events" className="w-[98%] object-contain" />
              </div>
            ...
            <div className="w-full border-t-[1.5px] border-[#c5a977] pt-[1%] mt-[1%] flex flex-col items-center">
              <p className="text-center text-[#222] text-[14px] font-bold tracking-wide leading-snug" style={{ fontFamily: '"Aladin", cursive' }}>
