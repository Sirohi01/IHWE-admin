...
const VisitorRegistrationForm = () => {
    ...
    return (
      <div className="relative animate-fadeIn">
        <div className="flex justify-between items-center p-3 bg-white border-b border-slate-200 shadow-sm sticky top-0 z-50">
          <h2 className="text-[16px] font-bold text-[#1a4d1a] tracking-tight ml-2">
          ...
          <div className="flex gap-6">
            ...
            <button
              ...
              className="px-4 py-1.5 text-xs font-bold uppercase bg-[#fff5f5] text-red-500 border border-red-500/50 rounded hover:bg-red-500 hover:text-white transition-all shadow-sm flex items-center gap-2"
            >
  ...
  if (visitorType === "international") {
    return (
      <div className="relative animate-fadeIn">
        <div className="flex justify-between items-center p-3 bg-white border-b border-slate-200 shadow-sm sticky top-0 z-50">
          <h2 className="text-[16px] font-bold text-[#d26019] tracking-tight ml-2">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center pb-3">
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium mt-1 max-w-3xl leading-relaxed">
            Register new visitors by capturing personal, company, and event information, <br />
            then route them to the correct visitor registration workflow.
          </p>
        </div>
        <div className="flex flex-col sm:items-end gap-2 mt-3 sm:mt-0 max-w-4xl">
          <div className="px-3 py-2.5 text-[10.5px] text-slate-600 bg-blue-50/60 border border-blue-200/60 rounded-md leading-relaxed text-left shadow-sm">
            ...
            This option should be used when a visitor needs assistance from the IHWE team or prefers not to register through the official website.
          </div>
        </div>
      </div>
      ...
      <div className="w-full mt-0 flex flex-col gap-1">
            ...
            <div className="relative z-10 pt-6 md:pt-8 pb-1 md:pb-2 flex flex-col gap-2 w-full md:w-[60%] lg:w-[55%] bg-black/40 md:bg-transparent p-4 md:p-0 rounded-2xl md:rounded-none backdrop-blur-sm md:backdrop-blur-none px-4 md:px-8">
              ...
              <div className="mt-1">
                <h1 className="text-3xl md:text-[38px] font-extrabold text-white leading-tight uppercase">
                  Register as a <br />
                  <span className="text-[#a8d060]">Visitor</span>
                </h1>
              </div>
        ...
        <section className="bg-white border border-gray-100 rounded-b-lg shadow-sm px-4 md:px-5 pb-2 md:pb-2 pt-2 md:pt-3 flex flex-col lg:flex-row gap-6 lg:gap-8 -mt-1">
          ...
          <div className="flex-1">
            <h3 className="text-gray-900 text-[17px] font-medium mb-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div
                onClick={() => setVisitorType("domestic")}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-xs">For visitors based in India</p>
                </div>
                <button
                  type="button"
                  className={`flex gap-2 items-center text-white text-xs font-medium uppercase tracking-widest px-5 py-2 rounded-lg transition-colors ${visitorType === "domestic" ? "bg-[#1a4d1a]" : "bg-[#23471d] hover:bg-[#1a4d1a]"}`}
                >
                  {visitorType === "domestic" ? "Selected" : "Register Now"}
                  <span className="w-5 h-5 rounded-full bg-white flex items-center justify-center shrink-0">
                    <svg className={`w-3 h-3 ${visitorType === "domestic" ? "text-[#1a4d1a]" : "text-[#23471d]"}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-xs">For visitors based outside India</p>
                </div>
                <button
                  type="button"
                ...
                >
                  {visitorType === "international" ? "Selected" : "Register Now"}
                  <span className="w-5 h-5 rounded-full bg-white flex items-center justify-center shrink-0">
                    <svg className={`w-3 h-3 ${visitorType === "international" ? "text-[#c96a18]" : "text-[#e07820]"}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M5 12h14M13 6l6 6-6 6" />
                    </svg>
                  </span>
                </button>
