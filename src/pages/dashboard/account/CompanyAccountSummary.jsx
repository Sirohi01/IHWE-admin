...
const CompanyLogo = ({ logo, name }) => {
  ...
  return (
    <div className="w-24 h-24 bg-[#f0fff9] rounded-xl flex items-center justify-center text-[#00b087] font-normal text-lg leading-tight text-center border border-[#e0f8f1] shrink-0 p-2">
      ...
      {items.map((item, idx) => (
        <div key={idx} className="flex justify-between items-center text-[10px] border-b border-gray-50 pb-1 last:border-0 last:pb-0">
          <div className="flex flex-col gap-0.5">
            <span className="font-normal text-slate-700">{item.no}</span>
            <span className="text-[9px] text-slate-400 leading-none">{item.type} {item.forNo ? `(${item.forNo})` : ''}</span>
          </div>
          <span className="font-normal text-slate-800 text-right">{formatCurrency(isRemaining ? (item.remainingAmount || item.amount) : item.amount)}</span>
        </div>
      ))}
    </div>
  );
        ...
        <div className="group relative bg-white rounded-xl shadow-sm border border-gray-200/60 hover:shadow-md hover:border-red-200 transition-all duration-300 p-3.5 flex flex-col justify-between h-full">
          ...
          <div className="flex justify-between items-start ml-1 relative z-10 mb-2">
            <div>
              ...
              <h3 className="text-[18px] font-normal text-[#1a2b4b] tracking-tight leading-none whitespace-nowrap mt-1">{formatCurrency(financials?.totalDue)}</h3>
            </div>
          ...
          <div className="ml-1 relative z-10 my-auto">
            <span className="text-[11px] font-normal text-slate-500 whitespace-nowrap">Proforma Invoices</span>
            <p className="text-[13px] font-normal text-[#1a2b4b] mt-0.5">{proformaInvoiceCount} Invoices</p>
          </div>

          <div className="pt-2 border-t border-gray-50 ml-1 relative z-10 flex flex-col gap-1">
            <span className="text-[11px] font-normal text-slate-500">Overdue Amount</span>
            <span className="inline-flex items-center px-2 py-1 rounded text-[12px] font-normal bg-red-50 text-red-600 w-fit tracking-tight">
          ...
          <div className="absolute top-[100%] left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[60]">
            <div className="px-3 py-2 border-b border-gray-100 bg-gray-50 rounded-t-lg">
              <span className="text-[10px] font-normal text-slate-600 uppercase">Amount Breakdown</span>
            </div>
        ...
        <div className="group relative bg-white rounded-xl shadow-sm border border-gray-200/60 hover:shadow-md hover:border-emerald-200 transition-all duration-300 p-3.5 flex flex-col justify-between h-full">
          ...
          <div className="flex justify-between items-start ml-1 relative z-10 mb-2">
            <div>
              ...
              <h3 className="text-[18px] font-normal text-[#1a2b4b] tracking-tight leading-none whitespace-nowrap mt-1">{formatCurrency(financials?.paidAmount)}</h3>
            </div>
          ...
          <div className="ml-1 relative z-10 my-auto">
            <span className="text-[11px] font-normal text-slate-500 whitespace-nowrap">Total Invoices</span>
            <p className="text-[13px] font-normal text-[#1a2b4b] mt-0.5">{invoiceCount} Invoices</p>
          </div>

          <div className="pt-2 border-t border-gray-50 ml-1 relative z-10 flex flex-col gap-1">
            <span className="text-[11px] font-normal text-slate-500">Received %</span>
            <span className="inline-flex items-center px-2 py-1 rounded text-[12px] font-normal bg-emerald-50 text-emerald-600 w-fit tracking-tight">
              {paidPct}%
            </span>
          </div>
          ...
          <div className="absolute top-[100%] left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[60]">
            <div className="px-3 py-2 border-b border-gray-100 bg-gray-50 rounded-t-lg">
              <span className="text-[10px] font-normal text-slate-600 uppercase">Payment Breakdown</span>
            </div>
        ...
        <div className="group relative bg-white rounded-xl shadow-sm border border-gray-200/60 hover:shadow-md hover:border-indigo-200 transition-all duration-300 p-3.5 flex flex-col justify-between h-full">
          ...
          <div className="flex justify-between items-start ml-1 relative z-10 mb-2">
            <div>
              ...
              <h3 className="text-[18px] font-normal text-[#1a2b4b] tracking-tight leading-none whitespace-nowrap mt-1">{formatCurrency(financials?.remainingBalance)}</h3>
            </div>
          ...
          <div className="pt-2 border-t border-gray-50 ml-1 relative z-10 flex flex-col gap-1">
            <span className="text-[11px] font-normal text-slate-500">Total Amount</span>
            <span className="inline-flex items-center px-2 py-1 rounded text-[12px] font-normal bg-indigo-50 text-indigo-600 w-fit tracking-tight">
          ...
          <div className="absolute top-[100%] right-0 min-w-[200px] w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[60]">
            <div className="px-3 py-2 border-b border-gray-100 bg-gray-50 rounded-t-lg">
              <span className="text-[10px] font-normal text-slate-600 uppercase">Remaining Breakdown</span>
            </div>
