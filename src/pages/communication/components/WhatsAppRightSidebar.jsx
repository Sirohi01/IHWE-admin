...
export default function WhatsAppRightSidebar() {
  const targetData = [
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="bg-white rounded-xl border border-[#EDF0F7] p-3">
        <h3 className="text-[16px] font-medium text-[#0F172A] mb-1">Today's WhatsApp Target</h3>
      ...
      <div className="bg-white rounded-xl border border-[#EDF0F7] p-3">
        ...
        <div className="flex flex-col gap-2">
          <input
            ...
            className="w-full border border-slate-200 rounded-lg px-3 py-2 text-[12px] focus:outline-none focus:border-indigo-500 bg-slate-50"
          />
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 border border-slate-200 rounded-lg px-3 py-1.5 text-[12px] focus:outline-none focus:border-indigo-500 bg-slate-50"
            />
          </div>
          <textarea
            placeholder="Type your message..."
            rows={2}
            className="w-full border border-slate-200 rounded-lg px-3 py-3 text-[12px] focus:outline-none focus:border-indigo-500 bg-slate-50 resize-none"
          ></textarea>
          <button className="w-full h-8 bg-[#25D366] hover:bg-[#128C7E] rounded-lg flex items-center justify-center text-white transition-colors gap-2 text-[13px] font-medium mt-1">
