...
const AddCrmWhatsappMessage = () => {
  ...
  return (
    <div
      className="w-full min-h-screen bg-[#ecf0f5]"
      ...
      <div className="p-6 space-y-6">
        ...
        >
          ...
          <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center border border-gray-300 rounded-md overflow-hidden h-11">
                  <input
                    ...
                    disabled={isLoading}
                  />
                  <div className="flex-1 px-3 py-2 text-base text-gray-600 truncate">
                    {formData.file_attach
                      ? formData.file_attach.name
                      : editingMessage?.file_attach &&
                          editingMessage.file_attach !== "N/A"
                  ...
                  <button
                    type="button"
                    onClick={handleChooseFileClick}
                    className="px-4 py-2 text-base bg-gray-100 border-l border-gray-300 hover:bg-gray-200"
                    disabled={isLoading}
                  >
                    Choose File
                  </button>
              ...
              <div className="border border-gray-300 rounded-md overflow-hidden">
                <div className="flex items-center gap-1 p-2 bg-gray-50 border-b border-gray-300">
                  <button
                    type="button"
                    onClick={() => applyFormatting("B")}
                    className="px-3 py-1 text-base font-bold border border-gray-300 rounded hover:bg-gray-200"
                    disabled={isLoading}
                  >
                    B
                  </button>
                  <button
                    type="button"
                    onClick={() => applyFormatting("I")}
                    className="px-3 py-1 text-base italic border border-gray-300 rounded hover:bg-gray-200"
                    disabled={isLoading}
                  >
                    I
                  </button>
                  <button
                    type="button"
                    onClick={() => setShowInlinePreview((prev) => !prev)}
                    className="ml-auto px-3 py-1 text-base border border-gray-300 rounded hover:bg-gray-200"
                    disabled={isLoading}
                  >
                    {showInlinePreview ? "Hide Preview" : "Show Preview"}
                  </button>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={5}
                  className="w-full px-4 py-2 text-base resize-y focus:outline-none"
                  placeholder="Write your message here... (Use *text* for bold/header, _text_ for italics)"
                  required
                  disabled={isLoading}
                />
            ...
            {/* Inline Preview */}
            {showInlinePreview && (
              <div className="p-4 border border-blue-400 bg-blue-50 rounded-md">
                <h4 className="text-base font-semibold mb-2">
                  WhatsApp Preview:
                </h4>
                <div
                  className="p-3 bg-white border border-gray-200 rounded whitespace-pre-wrap"
                  dangerouslySetInnerHTML={getPreviewContent(
                    formData.msg_descr,
                  )}
                />
            ...
            <div className="flex justify-end gap-3">
              <button
                type="submit"
                className="px-8 py-2 text-base text-white bg-[#3598dc] rounded-md hover:bg-[#2f82c4] disabled:opacity-60"
                disabled={isLoading}
              >
                {isLoading
                  ? editingMessage
              ...
              {editingMessage && (
                <button
                  type="button"
                  onClick={resetForm}
                  className="px-6 py-2 text-base text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 disabled:opacity-60"
                  disabled={isLoading}
                >
                  Cancel
                </button>
            ...
            <table className="w-full border-collapse">
              <thead className="sticky top-0 bg-gray-50 z-10">
                <tr className="border-b-2 border-gray-200">
                  ...
                  <th className="px-5 py-3 text-base font-semibold text-gray-700 text-left w-32">
                    Attachment
                  </th>
              ...
              <tbody>
                {isLoading && messages.length === 0 ? (
                  <tr>
                    <td
                      colSpan={6}
                      className="py-8 text-center text-blue-500 text-base"
                    >
                      <div className="inline-block animate-spin mr-2 border-2 border-gray-300 border-t-blue-500 rounded-full w-4 h-4" />
                      Loading Messages...
                    </td>
                  </tr>
                ) : messages.length === 0 ? (
                      ...
                      <td className="px-5 py-3 text-center">
                        <div className="flex justify-center gap-3">
                          <button
                            type="button"
                            onClick={() => handleEdit(item._id)}
                            className="p-2 border border-[#337ab7] text-[#337ab7] rounded hover:bg-[#337ab7]/10"
                            title="Edit"
                            disabled={isLoading}
                          >
                            <Pencil size={16} />
                          ...
                          <button
                            type="button"
                            onClick={() => handleDelete(item._id)}
                            className="p-2 border border-[#d9534f] text-[#d9534f] rounded hover:bg-[#d9534f]/10"
                            title="Delete"
                            disabled={isLoading}
                          >
                            <Trash2 size={16} />
