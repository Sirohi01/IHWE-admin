  ...
  const renderPaginationButtons = () => {
    ...
    buttons.push(
      <li
        ...
        className={`border border-gray-200 flex items-center justify-center h-12 w-16 cursor-pointer text-lg ${currentPage === 1
    ...
    if (totalPagesNum > 3) {
      ...
      buttons.push(
        <li
          ...
          className={`border border-gray-200 flex items-center justify-center h-12 w-14 cursor-pointer text-lg ${1 === currentPage
      ...
      buttons.push(
        <li
          ...
          className={`border border-gray-200 flex items-center justify-center h-12 w-14 cursor-pointer text-lg ${2 === currentPage
            ? "bg-[#337ab7] text-white"
            : "text-gray-600 hover:bg-gray-100"
            }`}
        >
      ...
      buttons.push(
        <li
          ...
          className={`border border-gray-200 flex items-center justify-center h-12 w-14 cursor-pointer text-lg ${3 === currentPage
            ? "bg-[#337ab7] text-white"
            : "text-gray-600 hover:bg-gray-100"
            }`}
        >
        ...
        if (i > 3 && i < totalPagesNum - 2) {
          buttons.push(
            <li
              ...
              className={`border border-gray-200 flex items-center justify-center h-12 w-14 cursor-pointer text-lg ${i === currentPage
                ? "bg-[#337ab7] text-white"
                : "text-gray-600 hover:bg-gray-100"
                }`}
            >
    ...
    buttons.push(
      <li
        key="next"
        onClick={() => handlePageChange(currentPage + 1)}
        className={`border border-gray-200 flex items-center justify-center h-12 w-16 cursor-pointer text-lg ${currentPage === totalPages
          ? "text-gray-300 cursor-not-allowed"
          : "text-gray-600 hover:bg-gray-100"
          }`}
      >
      ...
      <div className="flex flex-wrap justify-between items-center px-2 pb-2 print-hidden">
        <div className="flex items-center mb-4 md:mb-0">
          <select
            ...
            className="py-1.5 px-8 border border-gray-300 text-lg pl-4 "
          >
        ...
        <div className="flex flex-col md:flex-row items-center gap-3">
          {extrabutton && (
            <>
              <button
                onClick={handlePrint}
                className="text-[#2f353b] py-1.5 px-8 text-base text-center cursor-pointer hover:bg-black hover:text-white border border-[#2f353b]"
              >
                Print
              </button>
              <button
                onClick={exportToCsv}
                className="py-1.5 px-8 text-[#78a300] text-base text-center cursor-pointer hover:bg-[#78a300] hover:text-white border border-[#78a300]"
              >
                Excel
              </button>
            </>
          ...
          <div className="flex items-center w-full md:w-72">
            ...
            <input
              ...
              className="ml-2 px-3 h-10 border border-gray-300 text-lg outline-none hover:border-blue-500 w-full"
              type="text"
            />
          </div>
        </div>
          ...
          <table className="border border-gray-200 text-[#4f5a67] text-base font-semibold mb-5 w-full min-w-max">
            <thead>
              <tr className="bg-[#555555] text-white">
                <th className="h-12 w-[80px] pl-6 border border-gray-200 print-hidden">
                ...
                {colomns.map((col) => (
                  <th
                    ...
                    className="h-12 pl-6 border border-gray-200 text-center cursor-pointer select-none text-md"
