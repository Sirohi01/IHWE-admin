  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-2 lg:col-span-3 col-span-1 flex flex-col justify-start" style={{ boxShadow: 'rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em', fontFamily: 'Inter, sans-serif' }}>
      <div className="flex justify-between items-center mb-1">
        <h3 className="text-sm font-bold" style={{ color: '#15173D' }}>Sales Leaderboard</h3>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold truncate max-w-[90px]" style={{ color: '#15173D' }}>{item.name}</span>
              </div>
              <span className="text-[10px] font-black" style={{ color: '#016B61' }}>₹ {(item.revenue / 100000).toFixed(2)} L</span>
            </div>
          );
        })}
      </div>
