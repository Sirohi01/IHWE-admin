...
export default function EmailsRightSidebar() {
  const targetData = [
    ...
    <div className="space-y-1">
      ...
      <div className="bg-white rounded-xl border border-[#EDF0F7] p-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            rows={2}
            className="w-full border border-slate-200 rounded-lg px-3 py-2 text-[12px] focus:outline-none focus:border-indigo-500 bg-slate-50 resize-none"
          ></textarea>
          <button className="w-full h-8 bg-[#5E5E81] hover:bg-[#4B4B67] rounded-lg flex items-center justify-center text-white transition-colors gap-2 text-[13px] font-medium mt-1">
            <Mail size={14} />
            Send Email
          </button>
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#EDF0F7] p-3">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-[14px] font-medium text-[#0F172A]">Recent Activity</h3>
