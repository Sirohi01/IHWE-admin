...
const AbstractPresentationManage = () => {
    ...
    const fetchData = async () => {
        try {
            const res = await axios.get(`${API_URL}/abstract-presentation`);
            if (res.data.success) {
    ...
    const handleSave = async () => {
        try {
            ...
            const res = await axios.put(`${API_URL}/abstract-presentation`, data, {
        ...
        <div className="p-6 w-full bg-slate-50 min-h-screen">
            <div className="space-y-4 pr-8">
                <div className="flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-slate-800">Manage Abstract Submission</h1>
...
export default AbstractPresentationManage;
