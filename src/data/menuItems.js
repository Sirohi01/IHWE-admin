...
export const menuItems = [
  ...
  },
 {
  ...
  },
  {
    ...
    icon: Globe,
    children: [
      { label: "Home Slider", path: "/organic-carousel" },
      { label: "Supported By", path: "/organic-supported-by" },
      { label: "Upcoming Brands", path: "/organic-upcoming-brands" },
      { label: "Introduction", path: "/organic-introduction" },
      { label: "National Expo", path: "/organic-national-expo" },
      { label: "Integrated Format", path: "/organic-integrated-format" },
      { label: "Why Participate", path: "/organic-why-participate-manage" },
      { label: "Event Highlights", path: "/organic-event-highlights" },
      { label: "About Us", path: "/organic-about-us" },
      { label: "Add PDF", path: "/organic-add-pdf" },
      { label: "Marquee Text", path: "/organic-marquee-text" },
      { label: "Who We Are", path: "/organic-who-we-are" },
      { label: "Featured Services", path: "/organic-featured-services" },
      { label: "Healthcare Sectors", path: "/organic-healthcare-sectors" },
      { label: "E-Promotion Web", path: "/organic-epromotion" },
      { label: "FAQ Management", path: "/organic-faq-manage" },
      { label: "Event Glimpses", path: "/organic-glimpse" },
      { label: "Our Clients", path: "/organic-clients" },
      { label: "Parallax Image", path: "/organic-parallax-manage" },
      { label: "Testimonials", path: "/organic-testimonials-manage" },
      { label: "New Testimonials", path: "/organic-new-testimonials-manage" },
      { label: "Exhibitor Testimonials", path: "/organic-exhibitor-testimonials" },
      { label: "Counters", path: "/organic-stats-manage" },
      { label: "Floating Video", path: "/organic-floating-video-management" },
    ],
  },
  {
    type: "dropdown",
    ...
    icon: Info,
    children: [
      { label: "Carousel", path: "/organic-carousel" },
      { label: "Global Platform", path: "/organic-global-platform" },
      { label: "Event Overview", path: "/organic-event-overview" },
      { label: "About Organizer", path: "/organic-about-organizer" },
      { label: "Our Journey", path: "/organic-our-journey" },
      { label: "Vision & Mission", path: "/organic-vision-mission" },
      { label: "Why Attend", path: "/organic-why-attend" },
      { label: "Target Audience", path: "/organic-target-audience" },
      { label: "Organized By", path: "/organic-organized-by" },
    ],
  },
  {
    type: "dropdown",
    ...
    children: [
      { label: "Carousel", path: "/organic-carousel" },
      { label: "Gallery Categories", path: "/organic-gallery-category" },
      { label: "Add Gallery Images", path: "/organic-add-gallery-images" },
      { label: "Video Categories", path: "/organic-video-category" },
      { label: "Add Video", path: "/organic-gallery-videos" },
      { label: "Video Listings", path: "/organic-video-list" },
      { label: "Media Categories", path: "/organic-media-category" },
      { label: "Media Photos", path: "/organic-gallery-media" },
      { label: "All Gallery Listings", path: "/organic-gallery-list" },
      { label: "Media Registration Content", path: "/organic-media-registration-manage" },
    ],
  },
  {
    type: "dropdown",
    ...
    icon: Rocket,
    children: [
      { label: "Why Exhibit", path: "/organic-why-exhibit-manage" },
      { label: "Exhibitor Profile", path: "/organic-exhibitor-profile-manage" },
      { label: "E-Promotion Management", path: "/organic-e-promotion-manage" },
      { label: "Stall Designing Vendor", path: "/organic-stall-vendor-manage" },
      { label: "Travel & Accommodation", path: "/organic-travel-accommodation-manage" },
      { label: "Why Visit", path: "/organic-why-visit-manage" },
    ],
  },
  {
    type: "dropdown",
    ...
    icon: Sparkles,
    children: [
      { label: "Add Service", path: "/organic-create-service" },
      { label: "Services List", path: "/organic-service-list" },
    ],
  },
  {
    type: "dropdown",
    ...
    icon: FileText,
    children: [
      { label: "Add Blog", path: "/organic-add-blogs" },
      { label: "Blogs List", path: "/organic-blogs-list" },
      { label: "Expert Insights", path: "/organic-blog-experts" },
      { label: "Media Resources", path: "/organic-blog-resources" },
      { label: "Newsletter Subscribers", path: "/organic-blog-subscribers" },
    ],
  },
  {
    type: "dropdown",
    ...
    icon: TrendingUp,
    children: [
      { label: "Add Meta", path: "/organic-add-meta" },
      { label: "Meta List", path: "/organic-meta-list" },
      { label: "Advanced SEO", path: "/organic-advanced-seo" },
      { label: "Social Media", path: "/organic-social-media" },
      { label: "Background Images", path: "/organic-hero-images" },
      { label: "Exhibitor Hero Slider", path: "/organic-exhibitor-hero-slider" },
      { label: "Dashboard Banners", path: "/organic-dashboard-banners" },
    ],
  },
  {
    type: "dropdown",
    ...
    icon: MessageSquare,
    children: [
      { label: "Expo Enquiries", path: "/organic-expo-support-enquiries" },
      { label: "Sponsorship Enquiries", path: "/organic-sponsorship-enquiries" },
      { label: "Contact Enquiries", path: "/organic-contact-enquiries" },
      { label: "Sponsor Packages & Matrix", path: "/organic-sponsor-comparison-manage" },
    ],
  },
  {
    type: "item",
    label: "MSME PMS Page",
    icon: Settings,
    path: "/organic-msme-pms-scheme-config",
  },
