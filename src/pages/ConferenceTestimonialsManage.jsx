...
const ConferenceTestimonialsManage = () => {
    const [data, setData] = useState({
        ...
        description: 'Voices from the leaders of the industry.',
        cards: []
    });
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const response = await api.get('/api/conference-testimonials');
    ...
    const handleHeadingSave = async () => {
        setIsLoading(true);
        try {
            const response = await api.post('/api/conference-testimonials/headings', {
    ...
    const handleDeleteCard = async (cardId) => {
        ...
        setIsLoading(true);
        try {
            await api.delete(`/api/conference-testimonials/cards/${cardId}`);
                ...
                <div className="relative z-10 h-full flex items-center justify-between px-10">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-medium text-slate-200">
                            Manage testimonials for the conference page
                        </p>
                    </div>
...
export default ConferenceTestimonialsManage;
