...
const GeneralOverview = () => {
  ...
  const handlePost = async () => {
    ...
    if (updateGeneralVisitor.rejected.match(updateResult)) {
      return setPostError(
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-3 py-2">
                  {visitor.alternateNo ? (
                    <span className="text-gray-700">{visitor.alternateNo}</span>
                  ) : (
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-3 py-2">
                  {visitor.dateOfBirth ? (
                    <span className="text-gray-700">{visitor.dateOfBirth}</span>
                  ) : (
                    <span className="text-red-500">Pending</span>
                  )}
                </td>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td colSpan="5" className="px-3 py-2 text-gray-700">
                  {[
                    visitor.purposeOfVisit?.businessNetworking &&
                      "Business Networking",
                    visitor.purposeOfVisit?.exploringProducts &&
                      "Exploring New Products",
                    visitor.purposeOfVisit?.buyingProducts &&
              ...
              <tr className="border-b border-gray-200">
                ...
                <td colSpan="5" className="px-3 py-2 text-gray-700">
                  {[
                    visitor.areaOfInterest?.ayushHerbal &&
                      "AYUSH & Herbal Products",
                    visitor.areaOfInterest?.organicProducts &&
                      "Organic & Natural Products",
                    visitor.areaOfInterest?.fitnessWellness &&
                      "Fitness & Wellness",
                    visitor.areaOfInterest?.healthSupplements &&
                      "Health Supplements",
                    visitor.areaOfInterest?.healthcareServices &&
                      "Healthcare Services",
                    visitor.areaOfInterest?.agricultureFarming &&
                      "Agriculture & Farming",
                    visitor.areaOfInterest?.researchInnovations &&
                      "R&D & Innovations",
              ...
              {/* Row 7 — Subscribe + Created + Updated */}
              <tr className="border-b border-gray-200">
                <td className="font-medium px-3 py-2 text-gray-500 whitespace-nowrap bg-gray-50">
                  Subscribe
                </td>
